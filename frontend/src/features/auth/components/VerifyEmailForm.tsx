...
import { Eye, EyeOff, LockKeyhole, Link2Off } from "lucide-react";
import { Link, useNavigate, useSearchParams } from "react-router-dom";

import { useVerifyEmail } from "../hooks/useVerifyEmail";
import { useValidateVerificationToken } from "../hooks/useValidateVerificationToken";
...
export function VerifyEmailForm() {
  ...
  const getBackendErrorMessage = () => {
    ...
    const responseData = verifyMutation.error.response?.data;
      ...
      <div className="w-full">
        <div className="mb-5 flex justify-center">
          <div className="flex h-14 w-14 items-center justify-center rounded-full bg-red-100">
            <Link2Off className="h-7 w-7 text-red-500" strokeWidth={1.8} />
          </div>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="mt-2 font-body-sm text-body-sm text-slate-muted">
            Please use the verification link sent to your email to complete your
            account.
          </p>
        </div>
    ...
    return (
      <div className="w-full">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 font-body-sm text-body-sm text-slate-muted">
            This verification link is no longer valid or has been used. Please
